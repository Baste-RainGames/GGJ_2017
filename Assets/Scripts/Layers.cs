...
public static class Layers {
    ...
    private static void EnsureLayersInitialized() {
        ...
        geometryMaskWithoutBlink = 1 << LayerMask.NameToLayer("Default") | 1 << LayerMask.NameToLayer("3D");
        geometryMask = 1 << LayerMask.NameToLayer("Default") | 1 << LayerMask.NameToLayer("3D") | 1 << LayerMask.NameToLayer("Can_Blink_Though");
    }
